...
> First make sure all of the example data sets are downloaded. Once the data is downloaded and or the repository is cloned to your desktop using GitHub desktop, lets find our current working directory and then set it as our working directory. This will make it easier for us to point to files during the lesson. 

```{r}
getwd() # find our current working directory 
setwd("/Users/jessicahill/Documents/GitHub/CM515-course-2024") # set the directory we want as our current working directory
```
...
head(data4, 7) # if you read in over 7 lines, you will see his whole speech
```
